...
def handwritingClassTest():
	...
	for i in range(m):
		...
		trainignMat[i,:] = img2vector('./trainingDigits/%s' % filenameStr)
	...
	for i in range(mTest):
		...
		classfierResult = classfy0(vectorUnderTest,trainignMat,hwLabels,3)
		print 'the classifier came back with: %d, the real answer is: %d' % (classfierResult,classNumStr)
		if(classNumStr!=classfierResult):
			errorCount += 1.0
